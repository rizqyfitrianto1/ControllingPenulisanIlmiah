...
public class Fe_book1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fe_book1);
        //untuk judul ActionBar
        getSupportActionBar().setTitle("Panduan PI FE");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //untuk menampilkan pdf
        ftibook1=(PDFView)findViewById(R.id.pdfbook1);
        ftibook1.fromAsset("pedoman_fe.pdf").load();
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT > Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(Fe_book1Activity.this, "Cannot create folder!", Toast.LENGTH_SHORT).show();
                    }
                    //ini lokasi file yang akan didownload
                    new Fe_book1Activity.DownloadTask().execute("http://sap.gunadarma.ac.id/upload/PB-022610.pdf");
                }
            }
        });
    }
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog =  new ProgressDialog(Fe_book1Activity.this);
            ...
            mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    Toast.makeText(Fe_book1Activity.this,"Download cancelled!", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(String result) {
            ...
            if(result != null){
                Toast.makeText(Fe_book1Activity.this, "Error: " + result, Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(Fe_book1Activity.this, "Downloaded!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
