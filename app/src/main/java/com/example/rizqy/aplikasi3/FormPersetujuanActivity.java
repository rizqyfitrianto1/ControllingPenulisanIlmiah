...
public class FormPersetujuanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_persetujuan);
        //untuk judul ActionBar
        getSupportActionBar().setTitle("Form Persetujuan");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //untuk menampilkan pdf
        book1=(PDFView)findViewById(R.id.pdfbook1);
        book1.fromAsset("form_persetujuan.pdf").load();
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT > Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(FormPersetujuanActivity.this, "Cannot create folder!", Toast.LENGTH_SHORT).show();
                    }
                    //ini lokasi file yang akan didownload
                    new FormPersetujuanActivity.DownloadTask().execute("http://baak.gunadarma.ac.id/infopi/files/FORM-SURAT-PERSETUJUAN.pdf");
                }
            }
        });
    }
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog =  new ProgressDialog(FormPersetujuanActivity.this);
            ...
            mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    Toast.makeText(FormPersetujuanActivity.this,"Download cancelled!", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(String result) {
            ...
            if(result != null){
                Toast.makeText(FormPersetujuanActivity.this, "Error: " + result, Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(FormPersetujuanActivity.this, "Downloaded!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
