...
public class Fikti_book1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fikti_book1);
        //untuk judul ActionBar
        getSupportActionBar().setTitle("Panduan PI FIKTI");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //untuk menampilkan pdf
        ftibook1=(PDFView)findViewById(R.id.pdfbook1);
        ftibook1.fromAsset("pedoman_fikti.pdf").load();
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT > Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(Fikti_book1Activity.this, "Cannot create folder!", Toast.LENGTH_SHORT).show();
                    }
                    //ini lokasi file yang akan didownload
                    new Fikti_book1Activity.DownloadTask().execute("http://baak.gunadarma.ac.id/infopi/files/Revisi-Petunjuk-PI.pdf");
                }
            }
        });
    }
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog =  new ProgressDialog(Fikti_book1Activity.this);
            ...
            mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    Toast.makeText(Fikti_book1Activity.this,"Download cancelled!", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(String result) {
            ...
            if(result != null){
                Toast.makeText(Fikti_book1Activity.this, "Error: " + result, Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(Fikti_book1Activity.this, "Downloaded!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
