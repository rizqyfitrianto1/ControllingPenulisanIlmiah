...
public class FormNilaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_nilai);
        ...
        book1.fromAsset("form_nilai.pdf").load();
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT > Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(FormNilaiActivity.this, "Cannot create folder!", Toast.LENGTH_SHORT).show();
                    }
                    //ini lokasi file yang akan didownload
                    new FormNilaiActivity.DownloadTask().execute("http://baak.gunadarma.ac.id/infopi/files/form_nilai_PI.pdf");
                }
            }
        });
    }
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog =  new ProgressDialog(FormNilaiActivity.this);
            ...
            mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    Toast.makeText(FormNilaiActivity.this,"Download cancelled!", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(String result) {
            ...
            if(result != null){
                Toast.makeText(FormNilaiActivity.this, "Error: " + result, Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(FormNilaiActivity.this, "Downloaded!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
