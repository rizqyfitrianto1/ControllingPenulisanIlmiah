...
public class DosenAccount extends AppCompatActivity implements View.OnClickListener {

    private CardView ubahpasswordCard,aboutCard,keluarCard;

    TextView Nama,NIDN,Notelepon,Email;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dosen_account);
        ...
        Nama.setText(Common.currentDosen.getNama());

        NIDN = (TextView)findViewById(R.id.nidn);
        NIDN.setText(Common.currentDosen.getKodedospem());

        Notelepon = (TextView)findViewById(R.id.notelepon);
        Notelepon.setText(Common.currentDosen.getNotelepon());

        Email = (TextView)findViewById(R.id.email);
        Email.setText(Common.currentDosen.getEmail());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.ubahpassword:
                ...
                break;
            case R.id.about:
                AlertDialog.Builder info = new AlertDialog.Builder(DosenAccount.this);
            ...
            case R.id.keluar:
                ...
                Paper.book().destroy();
                //Logout
                Intent login2 = new Intent(DosenAccount.this, Status.class);
    ...
    private void showChangePasswordDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DosenAccount.this);
        ...
        alertDialog.setPositiveButton("SAVE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                final android.app.AlertDialog waitingDialog = new SpotsDialog(DosenAccount.this);
                waitingDialog.show();

                //Check password lama
                if(passwordlama.getText().toString().equals(Common.currentDosen.getPassword())){
                    ...
                    if(passwordbaru.getText().toString().equals(konfirmasi.getText().toString())){
                        ...
                        //Make Update
                        DatabaseReference dosen = FirebaseDatabase.getInstance().getReference("Dosen");
                        dosen.child(Common.currentDosen.getKodedospem())
                                .updateChildren(passwordUpdate)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        waitingDialog.dismiss();
                                        Toast.makeText(DosenAccount.this, "Password telah dirubah",Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Toast.makeText(DosenAccount.this, "",Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                    else {
                        waitingDialog.dismiss();
                        Toast.makeText(DosenAccount.this,"Password baru tidak cocok", Toast.LENGTH_SHORT).show();
                    }
                }
                else{
                    waitingDialog.dismiss();
                    Toast.makeText(DosenAccount.this,"Password lama salah", Toast.LENGTH_SHORT).show();
                }
            }
        });
